...
public class BlockSplit {
	...
	public Vector splitFile(File Sourcef, String ext) throws Exception {
		...
		if (ext.equalsIgnoreCase("ANI") || ext.equalsIgnoreCase("jpeg")
				|| ext.equalsIgnoreCase("png") || ext.equalsIgnoreCase("jpg")
				|| ext.equalsIgnoreCase("gif") || ext.equalsIgnoreCase("psd")
				|| ext.equalsIgnoreCase("pbm") || ext.equalsIgnoreCase("Mac")) {
		...
		else if (ext.equalsIgnoreCase("mpeg") || ext.equalsIgnoreCase("avi")
				|| ext.equalsIgnoreCase("wmv") || ext.equalsIgnoreCase("mpg")
				|| ext.equalsIgnoreCase("mp4") || ext.equalsIgnoreCase("vob")
		...
		else if (ext.equalsIgnoreCase("txt") || ext.equalsIgnoreCase("java")
				|| ext.equalsIgnoreCase("csv") || ext.equalsIgnoreCase("html")
		...
		System.out.println("=== " + sourceSize + " " + maxReadBufferSize + " "
				+ numSplits);
		long bytesPerSplit;
		long remainingBytes;
		...
		if (numSplits == 0) {
			...
			System.out.println("SIze less than 20 Kb..bytesPerSplit "
					+ bytesPerSplit + " remainingBytes" + remainingBytes);
		}
		...
		if (remainingBytes > 0) {
			mdP = MessageDigest.getInstance("MD5");
			// System.out.println("The last packet came with bytes "+
			// remainingBytes);
			packContent = new StringBuffer();
	...
	public void readWrite(RandomAccessFile raf, long numBytes)
			throws IOException {
		try {
